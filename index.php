...
if(isset($_GET["url"])) {
  ...
  try {
    ...
    $link1 = $aff.urlencode($_GET["url"]).'&sub1=giau-link&c=cpuv';
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Tạo link rút gọn nhanh chóng | <?php echo htmlspecialchars($linkity->name); ?></title>
  ...
  <body>
    ...
    <main class="page">
      ...
      <form class="shorten">
        ...
        <button>Tạo Link</button> <br><br><center>Website rút gọn link miễn phí:<br> Tốc độ nhanh và an toàn </center>
